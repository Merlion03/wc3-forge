...
export function AddImportFile(arg1:string):Promise<forge.ImportEntry>;
...
export function CheckForUpdate():Promise<update.CheckResult>;
...
export function DownloadAndRunInstaller(arg1:string):Promise<void>;
...
export function ListImports():Promise<Array<forge.ImportEntry>>;
...
export function RemoveImport(arg1:string):Promise<void>;

export function RenameImport(arg1:string,arg2:string):Promise<void>;
