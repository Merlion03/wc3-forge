...
<main>
  ...
  <div class="split" style="--right-col-width: {rightColWidthPx}px">
...
<style>
  ...
  /* 3-column layout: viewport (flexes) + vertical splitter (4px) + right
     column (user-resizable width via --right-col-width CSS var, set inline
     from the rightColWidthPx state and dragged via the Splitter on the left
     edge of the right column). */
  .split { flex: 1 1 auto; display: grid; grid-template-columns: 1fr 4px var(--right-col-width, 340px); min-height: 0; }
