...
$proc = Get-Process $name -ErrorAction SilentlyContinue | Where-Object MainWindowHandle -ne 0 | Select-Object -First 1
if (-not $proc) { Write-Error ("no " + $name + " window"); exit 1 }
